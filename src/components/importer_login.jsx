...
<div className={styles.logdiv} >
  ...
  <div>
  <Image src={loginimp} class="card-img-top" alt="..." style={{width:"300px", height:"300px", marginTop:"150px", marginLeft:"-20px"}}/>
  <Form>
