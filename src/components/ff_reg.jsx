...
import styles from './ff_reg.module.css';
...
<div>
<Image src={ff} alt="Image Description" fluid className={styles.regimg}/>
</div>
...
<div style={{marginTop:"30px"}}>
  ...
  <h4 onClick={() => window.location.href = '/login/freightForwarder'} style={{float:"right", color:"#000080", fontWeight:"400", fontSize:"20px", marginTop:"3px", cursor:"pointer", marginRight:"243px"}}>Sign In</h4>
</div>
